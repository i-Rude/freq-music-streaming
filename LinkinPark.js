const music = new Audio('audio/LinkinPark/1.mp3');
...
const songs = [
    {
        ...
        poster: "img/LinkinPark/1.jpg"
    },
    {
        id: 2,
        songName: `What I've Done <br> 
        <div class="subtitle">Linkin Park</div>`,
        poster: "img/LinkinPark/2.jpg"
    },
    {
        id: 3,
        songName: `Faint <br> 
        <div class="subtitle">Linkin Park</div>`,
        poster: "img/LinkinPark/3.jpg"
    },
    {
        id: 4,
        songName: `Lost <br> 
        <div class="subtitle">Linkin Park</div>`,
        poster: "img/LinkinPark/4.jpg"
    },
    {
        id: 5,
        songName: `Numb <br> 
        <div class="subtitle">Linkin Park</div>`,
        poster: "img/LinkinPark/5.jpg"
    }
];
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click', (el)=>{
        index = el.target.id;
        //console.log(index);
        music.src = `audio/LinkinPark/${index}.mp3`;
        poster_master_play.src = `img/LinkinPark/${index}.jpg`;
        music.play();
        
        masterPlay.classList.replace('bi-play', 'bi-pause');

        download_music.href = `audio/LinkinPark/${index}.mp3`;
